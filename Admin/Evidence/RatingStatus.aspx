<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster/Site.master" AutoEventWireup="true" CodeFile="RatingStatus.aspx.cs" Inherits="M3_Rating_RatingStatus" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">    
    ...
    <script type="text/javascript">
        ...
        function fnCaseStudy(BandId, RSPExcersiceID) {
            window.location.href = "frmAsseesorRating.aspx?str=" + RSPExcersiceID + "&BandId=" + BandId;
        }
        ...
        function fnGetStatus(CycleId) {
            ...
            PageMethods.frmGetStatus(LoginId,CycleId, function (result) {
                $("#loader").hide();
...
<asp:Content ID="Content2" ContentPlaceHolderID="ConatntMatter" runat="Server">
    <div class="section-title clearfix">
        <h3 class="text-center">Rating Status</h3>
