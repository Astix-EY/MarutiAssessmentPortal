<%@ Page Title="" Language="VB" MasterPageFile="~/DataB/MasterPage/Panel.master" AutoEventWireup="false" CodeFile="AboutSunriseGroup.aspx.vb" Inherits="Data_Information_AboutSunriseGroup" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ConatntMatterRight" runat="Server">
    ...
    <div id="dvEnglish">
        <div class="section-title">
            <h3 class="text-center">Commitment to Sustainability</h3>
            <%-- <h3 class="text-center">ABOUT SUNRISE GROUP OF INSTITUTIONS</h3>--%>
            <div class="title-line-center"></div>
        </div>
        <p>Genesis Industries is deeply committed to sustainability and environmental stewardship, integrating sustainable practices into our operations and business strategies. From investing in renewable energy projects to implementing eco-friendly technologies and promoting resource efficiency, we are dedicated to minimizing our environmental footprint and mitigating climate change impacts</p>
        
        <div class="section-title">
            <h3 class="text-center">Corporate Social Responsibility (CSR)</h3>
            <%-- <h3 class="text-center">ABOUT SUNRISE GROUP OF INSTITUTIONS</h3>--%>
            <div class="title-line-center"></div>
        </div>
       <p>As a responsible corporate citizen, Genesis Industries actively engages in initiatives aimed at improving the well-being of communities and fostering social development. Through philanthropic initiatives, community outreach programs, and partnerships with NGOs and government agencies, we strive to make a positive impact in areas such as education, healthcare, and rural development, empowering individuals and communities to thrive</p> 
        <div class="text-center mt-3 mb-3"><a href="#" onclick="fnMenu(6, this)" class="btns btn-submit">Next</a></div>
    </div>
    <!------------ End English------------------>
