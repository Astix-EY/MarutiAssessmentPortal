...
public class FileUploadHandler : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        try
        {
            ...
            else if (context.Request.QueryString["flgfilefolderid"].ToString() == "7") //For snapshots functionality
            {
                ...
                string picName = LoginId + "_" + RSPExerciseID + "_" + picTime.ToString("ddMMyyyyHHmmss") + ".png";
