<%@ Page Title="" Language="C#" MasterPageFile="~/MainTask/MasterPage/Site.master" AutoEventWireup="true" CodeFile="ParticipantExperienceEvaluation.aspx.cs" Inherits="Admin_MasterForms_ParticipantExperienceEvaluation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    ...
    <script type="text/javascript">
         ...
         function fnSubmit() {           
             ...
             window.location.href = "frmThanks.aspx";
         }
     </script>
    ...
    <script>
     ...
     <script type="text/javascript">
         ...
         function fnAutoSave() {
             ...
             PageMethods.fnSaveAuto(objDetail, LoginId, RspID, function (result) { }, function (result) { });
         }
