            ...
            else if (TypeID == 4)  // for textbox
            {
                ...
                for (int k = 0, loopTo4 = ds.Tables[1].Rows.Count - 1; k <= loopTo4; k++)
                {
                    ...
                    if (!string.IsNullOrEmpty(RsltVal))
                    {
                        ...
                        strInnerTable.Append("<textarea class='textEditor'  cols='200' multiline='false'  rows='200'   class='form-control' style='width:100%; height:180px'>" + RsltVal.Split('^')[1] + "</textarea>");
                        strInnerTable.Append("</td>");
                        strInnerTable.Append("</tr>");
                    }
                    else
                    {
                        ...
                        strInnerTable.Append("<td>");
                        //strInnerTable.Append("<input type='textbox'   id='rdoAns" + k + "^" + (k + 1) + "' class='form-control' style='width:250px'>");
                        strInnerTable.Append("<textarea class='textEditor' cols='200' multiline='false'  rows='200'   class='form-control' style='width:100%;height:180px'></textarea>");
                        strInnerTable.Append("</td>");
                        strInnerTable.Append("</tr>");
                    }
                }
