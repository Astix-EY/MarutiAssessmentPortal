...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function fnGetStatus() {
            $("#loader").show();
            var LoginId = $("#ConatntMatter_hdnLogin").val();
            var BandId = $("#ddlBand").val();
            var CycleID = $("#ConatntMatter_ddlCycleName").val();
            PageMethods.frmGetStatus(LoginId, BandId, CycleID, function (result) {
                $("#loader").hide();
        ...
        function fnDownload() {
            window.open("frmDownloadExcel.aspx?flg=1&band=" + $("#ddlBand option:selected").text());
        }
    </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ConatntMatter" runat="Server">
    ...
    <div style="padding: 5px; display: none">
        <b>Band:</b>
        <select onchange="fnChangeBand()" id="ddlBand">
    ...
    <div class="form-group row">
        ...
        <div class="col-3">
            <asp:DropDownList ID="ddlCycleName" runat="server" CssClass="form-control" onchange="fnGetStatus()" AppendDataBoundItems="true">
            </asp:DropDownList>
        </div>

       <%-- <div class="col-5">--%>
            <div id="div1"  class="col-5"  style="text-align-last: right">
                <input type="button" class="btns btns btn-submit btns-small ml-5" value="Download Excel" onclick="fnDownload()" />
