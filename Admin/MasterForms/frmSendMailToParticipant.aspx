<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/AdminMaster/Site.master" AutoEventWireup="false" CodeFile="frmSendMailToParticipant.aspx.vb" Inherits="Admin_MasterForms_frmSendMailToParticipant" %>
                ...
                $("input[type=checkbox]").each(function ()
                {
                    if ($(this).is(":checked"))
                    {
                        ...
                        strCycleParticipantArr = [{
                            ParticipantID: ParticipantID, ParticipantEmailID: ParticipantEmailID, Fname: Fname
                        }];
