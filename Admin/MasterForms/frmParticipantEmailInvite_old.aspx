<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster/Site.master" AutoEventWireup="true" CodeFile="frmParticipantEmailInvite_old.aspx.cs" EnableEventValidation="false" Inherits="frmParticipantEmailInvite" %>
    ...
    <script>
        ...
        function fnSave(flg) {
            ...
            $("#ConatntMatter_divdrmmain").find("#tbldbrlist input[flg=1]:checked").each(function () {
                var Name = $(this).closest("tr").find("td").eq(1).html().trim();
                var EmailId = $(this).closest("tr").find("td").eq(2).html().trim();
                ...
                var SchedulerFlagValue = $(this).closest("tr").attr("flgRescheduleMail");
                //alert(StartTime)
              //  alert(EndTime)
        ...
        function fnSave_Success(result, flgStatus) {
            ...
            if (result.split("|")[0] == "0") {
                ...
                $("#tbldbrlist  input[type=checkbox]:checked").closest("tr").attr("flgNewMail", "2");
