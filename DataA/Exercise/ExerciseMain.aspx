<%@ Page Title="" Language="VB" MasterPageFile="~/DataA/MasterPage/Panel.master" AutoEventWireup="false" CodeFile="ExerciseMain.aspx.vb" Inherits="Set1_Main_frmExerciseMain_New" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ConatntMatterRight" runat="Server">
    ...
    <div class="text-center mb-3" style="display: block">
        <asp:Button ID="btnFinalSubmit" runat="server" CssClass="btns btn-cancel" Text="Select Next Task" OnClientClick="fnShowFinalSubmitAlert(this); return false;" />
