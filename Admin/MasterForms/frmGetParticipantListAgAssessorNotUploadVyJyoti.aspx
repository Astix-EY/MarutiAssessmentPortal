<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster/Site.master" AutoEventWireup="true" CodeFile="frmGetParticipantListAgAssessorNotUploadVyJyoti.aspx.cs" Inherits="Admin_Evidence_frmGetParticipantListAgAssessor" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">    
    ...
    <script type="text/javascript">
        function fnStartMeeting(sender) {
            ...
            fnUpdateActualStartEndTime(sender, UserTypeID, flgAction, RspExerciseID);

        }
        function fnUpdateActualStartEndTime(sender, UserTypeID, flgAction, RspExerciseID) {
            $("#loader").show();
        ...
        function fnEnableExerciseAutomatically() {
            try {
                ...
                PageMethods.fnGetParticipantDetails(8, LoginId, 2, function (result) {
                    if (result != "") {
        ...
        $(document).ready(function () {
            var LoginId = $("#ConatntMatter_hdnLoginId").val();
            $("#loader").show();
            PageMethods.fnGetParticipantDetails(8, LoginId,1, fnGetDisplaySuccessData, fnGetFailed);
        });
