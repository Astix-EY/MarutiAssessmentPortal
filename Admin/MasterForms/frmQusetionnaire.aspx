<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster/SiteOne.master" AutoEventWireup="true" CodeFile="frmQusetionnaire.aspx.cs" Inherits="CommonData_Questionnaire_frmQusetionnaire" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    <script src="../../Scripts/jquery-ui.js"></script>
    <script src="../../Scripts/jqueryui-touch-punch_0.2.2.min.js"></script>
    ...
    <script>
        ...
        $(function () {
            ...
            if ($("#ConatntMatterRight_hdnExerciseStatus").val() == 2) {
                $("#ConatntMatterRight_divMainContainer").find("input").prop("disabled", true);
            }
        });
    ...
    <script type="text/javascript">
        ...
        function fnSave() {
            ...
            if (QstnTypeId == 7 || QstnTypeId == 8 || QstnTypeId == 9) {
                ...
                else if ($("#ConatntMatterRight_divMainContainer").find("div[IsHeShe=1]").length > 0) {
