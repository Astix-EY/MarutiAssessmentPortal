<%@ Page Title="" Language="C#" MasterPageFile="~/Task/MasterPage/Site.master" AutoEventWireup="true" CodeFile="frmSelfie.aspx.cs" Inherits="Admin_Setting_frmSelfie" %>
...
<script>
        function fnBackPage() {
            window.location.href = "../../Task/Exercise/Instructions.aspx";
        }
</script>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ConatntMatter" runat="Server">
     <div class="section-title">
       <h3 class="text-center">Let's take a photograph</h3>
                    ...
                    <td colspan="2" style="vertical-align:top">
                        <div>
                            ...
                            <%--    <li>When you click on next, you will be directed to the next page where you will be required to click 3 selfies.</li>--%>
                                <li>Please ensure your camera is switched on and provide your browser (Google Chrome, MS Edge, etc) with permission to use your camera.</li>
...
<input type="button" class="btns btn-submit" value="Back" onclick="fnBackPage()" />
