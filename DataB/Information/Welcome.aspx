<%@ Page Title="" Language="VB" MasterPageFile="../MasterPage/Site.master" AutoEventWireup="false" CodeFile="Welcome.aspx.vb" Inherits="Data_Information_Welcome" %>
...
<div class="latter-panel">
        <div class="latter-panel_header">
            <p>Note from Leadership</p>
            <h2>Our Commitment</h2>
            <h5>To development. to our people and to the future.</h5>
        </div>
        <div class="latter-panel_body" id="dvEnglish" style="display:none">
            ...
            <p>Good luck.</p>
            <p class="text-right font-weight-bold">Leadership</p>           
        </div>
