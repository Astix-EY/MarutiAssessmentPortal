...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script type="text/javascript">
        function fnDeleteParticipantMapping(Sender) {
            ...
            $("#dvDialog")[0].innerHTML = "Are you sure you want to remove this user from this cycle"
            $("#dvDialog").dialog({
                width: "400",
                modal: true,
                title: "Alert",
        ...
        function fnChkSuccessMapped(result, Sender) {
            ...
            if (result.split("@")[0] == "1") {
                ...
                if (chkFlag == "1") {
                    ...
                    $("#dvDialog")[0].innerHTML = "You can not remove this user because s/he has already started his/her Assessment."
                    $("#dvDialog").dialog({
                        width: "450",
                        modal: true,
                        title: "Alert",
        ...
        function fnDeleteSuccess(result, sender) {
            if (result.split("@")[0] == "1") {
                ...
                $(sender).closest("tr").attr("flgactive", "0");
