...
Partial Class L3DirectSales_Task2_CaseProbing
    ...
    Private Sub btnStartENG_Click(sender As Object, e As EventArgs) Handles btnStartENG.Click
        Response.Redirect("frmQusetionnaire.aspx?MenuId=8" & "&ExerciseID=" & hdnExerciseID.Value & "&RspID=" & hdnRspID.Value & "&BandID=1" & "&intLoginID=" & hdnLoginID.Value & "&ToolID=" & hdnToolID.Value)
    End Sub
