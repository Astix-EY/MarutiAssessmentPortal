<%@ Page Title="" Language="VB" MasterPageFile="../MasterPage/Site.master" AutoEventWireup="false" CodeFile="Instructions.aspx.vb" Inherits="Data_Information_Instructions" %>
    ...
    <div class="container">
        <div class="position-relative mb-5">
            ...
            <div class="section-title">
                <h3 class="text-center" id="hdnWelcome">Welcome to Assessement !</h3>
                ...
                <div class="col-sm-6 col-md-4">
                    <div id="dv1" class="panel-box panel-box-default" onclick="openPopup('div1');">
                        ...
                        <div class="panel-footer">
                            ...
                            Competency Development Inventory Tool
                        </div>
                    </div>
                </div>
