<%@ Page Title="" Language="VB" MasterPageFile="~/MainTask/MasterPage/Site.master" AutoEventWireup="false" CodeFile="Mytask.aspx.vb" Inherits="Data_Information_myTask" %>
    ...
    <script type="text/javascript">
        ...
        function fnChangeDataBasedOnLanguage(X)
        {
            ...
            if (LngID == 2)
            {
                ...
                $("#dvInventory").html("Inventarisasi Kemampuan");
                ...
                $("#dvInventory").html("ශක්‍යතා ඉන්වෙන්ටරි");
        ...
        function fnAssessment()
        {
            ...
            window.location.href = "ExerciseMain.aspx";
                ...
                <div class="col-sm-6 col-md-3">
                      <div class="panel-box panel-box-default">
                        <div class="panel-box-title">
                            ...
                            <div class="panel-box-title-text" id="dvInventory">Capability Inventory</div>
                        </div>
                        <div class="panel-body">
                            <table class="table">
                                <tbody>
