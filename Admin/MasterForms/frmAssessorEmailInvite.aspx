<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster/Site.master" AutoEventWireup="true" CodeFile="frmAssessorEmailInvite.aspx.cs" EnableEventValidation="false" Inherits="frmAssessorEmailInvite" %>
    ...
    <script>
        ...
        function fnSave(flg) {
            ...
            $("#ConatntMatter_divdrmmain").find("#tbldbrlist input[flg=1]:checked").each(function () {
                ...
                var EmailId = $(this).closest("tr").attr("AssessorEmailID");
                ...
                var FullName = $(this).closest("tr").attr("FullName");
                var EmpNodeID = $(this).closest("tr").attr("EmpNodeID");
                var ParticipantAssessorMappingID = $(this).closest("tr").attr("ParticipantAssessorMappingID");
              ...
              //  alert(EndTime)
                ...
                ArrDataSaving.push({ ParticipantName: ParticipantName, ParticipantAssessorMappingID: ParticipantAssessorMappingID, EmpNodeID: EmpNodeID, FullName: FullName, EmailId: EmailId, Subject: Subject, StartTime: StartTime, EndTime: EndTime, MailStatus: '' });
            });
            ...
            if (result.split("|")[0] == "0") {
                ...
                if (tbl.length > 0) {
                    ...
                    for (var i in tbl) {
                        ...
                        var AssessorName = tbl[i]["FullName"];
    ...
    <script type="text/javascript">
        ...
        function fnShowDataAssigned(X) {
            ...
            if (X == 1)   ////// Assigned
            {
                ...
                $("#tbldbrlist  tbody tr[flgNewMail=1]").css("display", "table-row")
            ...
            {
                $("#tbldbrlist tbody tr").hide();
                $("#tbldbrlist  tbody tr[flgNewMail=2]").css("display", "table-row")
...
<asp:Content ID="Content3" ContentPlaceHolderID="ConatntMatter" runat="Server">
    <div class="section-title clearfix">
        <h3 class="text-center">Invitatation Mail To Assessor <h3>
    ...
    <div class="body-content">
        ...
        <ul class="nav nav-tabs" role="tablist" id="tablist">
            <li><a class="nav-link active" onclick="fnShowDataAssigned(1)" style="cursor:pointer">Invitation Mail</a></li>
            <li><a class="nav-link"  onclick="fnShowDataAssigned(2)" style="cursor:pointer">Updated Schedule Mail</a></li>
            <li style="display:none"><a class="nav-link"  onclick="fnShowDataAssigned(3)" style="cursor:pointer">Resend Email</a></li>
        </ul>
