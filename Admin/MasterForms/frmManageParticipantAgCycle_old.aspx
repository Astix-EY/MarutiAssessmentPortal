<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/AdminMaster/Site.master" AutoEventWireup="false" CodeFile="frmManageParticipantAgCycle_old.aspx.vb" Inherits="Admin_MasterForms_frmManageParticipantAgCycle" %>
              ...
              //  $("#loader").show()
               ...
               // debugger;
                ...
                $("input[type=checkbox][flg=1]").each(function () {
                    var ParticipantID = $(this).attr("ParticipantID");
                    var ManagerNodeId = $(this).closest("tr").find('option:selected').val();
                    chkflag = this.checked ? "1" : "0";
                    //alert(ManagerNodeid)
                    if (ManagerNodeId == "0")
                    {
                        alert("Please select the manager for the selected checkbox")
                        return false;
                    }
                    strCycleParticipantArr = [{
                        CycleID: CycleID, ParticipantID: ParticipantID, chkflag: chkflag, BandId: BandId, ManagerNodeId: ManagerNodeId
                    }];
                    objDetail.push(strCycleParticipantArr[0]);
                });
    ...
    <script type="text/javascript">
        ...
        function fnDeleteSuccess(result, sender) {
            if (result.split("@")[0] == "1") {
                ...
                $(sender).closest("tr").find('option:selected').val(0);
...
<asp:Content ID="Content3" ContentPlaceHolderID="ConatntMatter" runat="Server">
    ...
    <div class="section-title clearfix">
        <h3 class="text-center">Cycle Mapping With Participant</h3>
