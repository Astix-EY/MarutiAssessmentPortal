...
<asp:Content ID="Content3" ContentPlaceHolderID="ConatntMatterRight" runat="Server">
    ...
    <div id="dvEnglish">
        <div class="section-title">
            <h3 class="text-center">Financial Highlights</h3>
        ...
        <p>Year-over-Year Growth: 9.4%</p>
        <p>Profitability:&nbsp; Net Profit Margin: 8.5%</p>
        <p><strong>Unit wise contribution to Revenue:</strong></p>
        <div class="col-7">
            <img src="../../Images/CaseStudy_Image1.png" class="img-thumbnail" />
        </div>

        <p><strong>Geography wise company performance:</strong></p>
        <div class="col-8">
            <img src="../../Images/CaseStudy_Image2.png" class="img-thumbnail" />
        </div>
        <div class="col-8">
            <img src="../../Images/CaseStudy_Image3.png" class="img-thumbnail" />
        </div>
    </div>
